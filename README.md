...
`We compared the results of the two tasks, i.e., scrutinizing the start and end points of CDSs and searching for new CDSs in the area between CDSs, between the results obtained manually by Mr. Yoshioka and the results obtained by using this script.`  
